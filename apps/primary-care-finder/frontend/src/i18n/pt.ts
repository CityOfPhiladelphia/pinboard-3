export default {
  ...
  introPage: {
    ...
    p25: 'O programa BenePhilly da Filadélfia oferece suporte gratuito para ajudar os residentes a se inscreverem no seguro saúde. Para saber mais, visite',
  ...
  patientType: {
    ...
    patient_type_new: 'Pacientes novos ou existentes',
  ...
  specialty: {
    ...
    eye: 'Cuidados oftalmológicos',
    podiatry: 'Podologia',
    mat: 'Tratamento assistido por medicamentos (MAT)',
