...
export function useFilterChipDefinitions() {
  ...
  const filterChipDefinitions = computed<FilterDefinition[]>(() => [
    ...
    },
    {
      ...
      multiple: true,
      choices: [
        { text: t('visitType.well'), value: visitTypeOptions.visitTypeOption0, tooltip: t('tooltips.well') },
        ...
        { text: t('visitType.women'), value: visitTypeOptions.visitTypeOption4, tooltip: t('tooltips.women') },
        ...
        { text: t('specialty.mat'), value: specialtyOptions.specialtyOption4, tooltip: t('tooltips.mat') },
